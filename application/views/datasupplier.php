<?php $this->view('header');?>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            $x=1;
											foreach($joinbahan as $ambil){
                                        ?>
                                            <tr>
                                                <td><?php echo $x;?></td>
                                                <td><?php echo $ambil->nama_supplier?></td>
                                                <td><?php echo $ambil->alamat?></td>
                                                <td><?php echo $ambil->no_hp?></td>
                                                <td><?php echo $ambil->nama_bahan?></td>
                                                <td width="20px;"><a href="#edit-data<?php echo $ambil->kode_supplier?>" data-toggle="modal" class="btn btn-warning" >Edit</a></td>
												<td width="20px;"><a href="<?php echo base_url('index.php/ctrlsupplier/deletedata/'.$ambil->kode_supplier.'')?>" class="btn btn-danger" >Hapus</a></td>
                                            </tr>
                                        <?php 
                                            $x++;  
        ...
        <script src="<?php echo base_url('assets/admin/js/AdminLTE/jquery/multiple.select.js')?>" type="text/javascript"></script>
        ...
        <script type="text/javascript">
			...
			$(document).ready(function(){
				$('#bahan').multipleSelect({
					placeholder: "Pilih Bahan",
					filter:true
				});
			});
        </script>
<?php foreach ($joinbahan as $ambil) {
		?>
				<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data<?php echo $ambil->kode_supplier?>" width="75%" class="modal fade">
			    <div class="modal-dialog">
			        <div class="modal-content">
			            ...
			            <form class="form-horizontal" action="<?php echo base_url('index.php/ctrlsupplier/editdata')?>" method="post" enctype="multipart/form-data" role="form">
				            <div class="modal-body">
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Kode Supplier</label>
				                        <div class="col-lg-12">
                                            <input type="text" class="form-control" readonly id="jenjang" name="id" value="<?php echo $ambil->kode_supplier?>">
				                        </div>
                                    </div>
				                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Nama Supplier</label>
				                        <div class="col-lg-12">
				                        	<input type="text" class="form-control" id="jenjang" name="nama" placeholder="Nama" value="<?php echo $ambil->nama_supplier?>">
				                        </div>
                                    </div>
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Nomor Hp</label>
				                        <div class="col-lg-12">
				                        	<input type="text" required maxlenght="12" onkeypress="return hanyaAngka(event)" class="form-control" id="jenjang" name="nohp" value="<?php echo $ambil->no_hp?>" placeholder="Nomor Handphone">
				                        </div>
				                    </div>
                                    <div class="form-group">
                                           <label class="col-lg-3 col-sm-1">Alamat</label>
                                        <div class="col-lg-12">
                                            <textarea name="alamat" class="form-control" required placeholder="Alamat"><?php echo $ambil->alamat?></textarea>
				                        </div>
				                    </div>
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Bahan</label>
				                        <div class="col-lg-12">
                                            <select name="kd_bahan" class="form-control">
												<option value="<?php echo $ambil->kode_bahan?>"><?php echo $ambil->nama_bahan?></option>
                                                <option value="">-----</option>
													<?php foreach($databahan as  $ambil){?>
												<option value="<?php echo $ambil->kode_bahan?>"><?php echo $ambil->nama_bahan?></option>
													<?php }?>
											</select>
				                        </div>
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="insert-data" width="75%" class="modal fade">
			    <div class="modal-dialog">
			        <div class="modal-content">
			            <div class="modal-header">
			                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
			                <h4 class="modal-title">Insert Data Supplier</h4>
			            </div>
			            <form class="form-horizontal" action="<?php echo base_url('index.php/ctrlsupplier/insertdata')?>" method="post" enctype="multipart/form-data" role="form">
				            <div class="modal-body">
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Kode Supplier</label>
				                        <div class="col-lg-12">
				                    ...
				                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Nama Supplier</label>
				                        <div class="col-lg-12">
				                        	<input type="text" required class="form-control" id="jenjang" name="nama" placeholder="Nama Supplier">
				                        </div>
				                    </div>
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Nomor Hp</label>
				                        <div class="col-lg-12">
				                        	<input type="text" required maxlenght="12" onkeypress="return hanyaAngka(event)" class="form-control" id="jenjang" name="nohp" placeholder="Nomor Handphone">
				                        </div>
				                    </div>
                                    <div class="form-group">
                                           <label class="col-lg-3 col-sm-1">Alamat</label>
                                    ...
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Bahan</label>
				                        <div class="col-lg-12">
                                            <select name="kd_bahan" required class="form-control">
													<?php foreach($databahan as  $ambil){?>
												<option value="<?php echo $ambil->kode_bahan?>"><?php echo $ambil->nama_bahan?></option>
													<?php }?>
											</select>
