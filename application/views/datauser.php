                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
											$x=1;
											foreach($datauser as $ambil){
                                        ?>
                                            <tr>
                                                <td><?php echo $x;?></td>
                                                <td><?php echo $ambil->nama?></td>
                                                <td><?php if($ambil->status == 0){ echo $tes = "STAFF";}elseif($ambil->status == 1){ echo $tes = "ADMIN"; }else{ echo $tes = "OWNER";}?></td>
                                                <td width="20px;"><a href="#edit-data<?php echo $ambil->id?>" data-toggle="modal" class="btn btn-warning" >Edit</a></td>
												<td width="20px;"><a href="<?php echo base_url('index.php/ctrluser/deletedata/'.$ambil->id.'')?>" onclick="return confirm('Anda Yakin Ingin Hapus Data Ini?')" class="btn btn-danger" >Hapus</a></td>
                                            </tr>
                                        <?php 
                                            $x++;    
                                            }
