                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
											$x=1;
											foreach($databahan as $ambil){
                                        ?>
                                            <tr>
                                                <td><?php echo $x;?></td>
                                                <td><?php echo $ambil->nama_bahan?></td>
                                                <td width="20px;"><a href="#edit-data<?php echo $ambil->kode_bahan?>" data-toggle="modal" class="btn btn-warning" >Edit</a></td>
												<td width="20px;"><a href="<?php echo base_url('index.php/ctrlbahan/deletedata/'.$ambil->kode_bahan.'')?>" class="btn btn-danger" >Hapus</a></td>
                                            </tr>
                                        <?php 
                                            $x++;    
                                            }
...
<?php foreach ($databahan as $ambil) {
		?>
				<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data<?php echo $ambil->kode_bahan?>" width="75%" class="modal fade">
			    <div class="modal-dialog">
			        <div class="modal-content">
			            ...
			            <form class="form-horizontal" action="<?php echo base_url('index.php/ctrlbahan/editdata')?>" method="post" enctype="multipart/form-data" role="form">
				            <div class="modal-body">
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Kode Bahan</label>
				                        <div class="col-lg-12">
                                            <input type="text" readonly class="form-control" id="jenjang" name="id" value="<?php echo $ambil->kode_bahan?>">
				                        </div>
				                    </div>
				                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Nama Bahan</label>
				                        <div class="col-lg-12">
				                        	<input type="text" class="form-control" id="jenjang" name="nama" placeholder="Nama" value="<?php echo $ambil->nama_bahan?>">
				                        </div>
				                    </div>
				                </div>
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="insert-data" width="75%" class="modal fade">
			    <div class="modal-dialog">
			        <div class="modal-content">
			            ...
			            <form class="form-horizontal" action="<?php echo base_url('index.php/ctrlbahan/insertdata')?>" method="post" enctype="multipart/form-data" role="form">
				            <div class="modal-body">
                                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Kode Bahan</label>
				                        <div class="col-lg-12">
                                            <input type="text" readonly class="form-control" id="jenjang" name="id" value="<?php echo $kode?>">
				                        </div>
				                    </div>
				                    <div class="form-group">
				                        <label class="col-lg-3 col-sm-1">Nama Bahan</label>
				                        <div class="col-lg-12">
				                        	<input type="text" required class="form-control" id="jenjang" name="nama" placeholder="Nama Bahan">
				                        </div>
				                    </div>
				                </div>
				                <div class="modal-footer">
